...
class AnimationManager {
    ...
    // Mostrar carta de amor con animaciones
    showLoveLetter() {
        // Prevenir duplicados
        ...
        if (!mainContent || !buttonContainer) return;
...
<p class="letter-text">
    Mi amor precioso,  
    desde que te conocí supe que eras especial. Tu sonrisa ilumina mis días y tu risa siempre me alegra. 
    Cada momento contigo se siente ligero y bonito, y haces que todo tenga un toque especial. 
    Este San Valentín no se trata de regalos, sino de disfrutar lo bien que se siente compartir contigo.  
    <br><br>
    ❤️ Me encantas ❤️
</p>
                </div>
